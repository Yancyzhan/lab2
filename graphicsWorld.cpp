...
cout << "the area of " << c.getName() <<" is: "<< c.getArea() << endl;
cout << "the perimeter of " << c.getName() << " is: "<< c.getPerimeter() << endl;
d = a.distance(c);
cout << "\nThe distance between rectangle a and circle c is: " <<d <<endl;

CurveCut rc (6, 5, 10, 12, 9, "CurveCut rc");
rc.display();
cout << "the area of " << rc.getName() <<" is: "<< rc.getArea();
cout << "the perimeter of " << rc.getName() << " is: "<< rc.getPerimeter();
d = rc.distance(c);
...
sha[3] = &rc;
sha [0]->display();
cout << "\nthe area of "<< sha[0]->getName() << "is: "<< sha[0] ->getArea();
cout << "\nthe perimeter of " << sha[0]->getName () << " is: "<< sha[0]->getPerimeter();
sha [1]->display();
cout << "\nthe area of "<< sha[1]->getName() << "is: "<< sha[1] ->getArea();
cout << "\nthe perimeter of " << sha[0]->getName () << " is: "<< sha[1]->getPerimeter();
sha [2]->display();
cout << "\nthe area of "<< sha[2]->getName() << "is: "<< sha[2] ->getArea();
cout << "\nthe circumference of " << sha[2]->getName ()<< " is: "<< sha[2]->getPerimeter();
sha [3]->display();
cout << "\nthe area of "<< sha[3]->getName() << "is: "<< sha[3] ->getArea();
cout << "\nthe perimeter of " << sha[3]->getName () << " is: "<< sha[3]->getPerimeter();
...
cc2.display();
#endif
} // END OF FUNCTION run			// end of block to test array of pointer and polymorphism
